    ...
    <div class="flex items-center justify-between">
      ...
      <div class="flex items-center space-x-8">
        ...
        <ul class="hidden lg:flex items-center gap-6 md:gap-8 py-3">
          ...
          <li><a href="{{ route('product.index') }}" class="text-sm font-medium text-gray-900 hover:text-blue-700">Produk</a></li>
          <li><a href="{{ route('category.index') }}" class="text-sm font-medium text-gray-900 hover:text-blue-700">Kategori</a></li>
        </ul>
      </div>
