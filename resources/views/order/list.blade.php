          ...
          <div class="mx-auto max-w-5xl">
            ...
            <div class="mt-6 flow-root sm:mt-8">
              <div class="divide-y divide-gray-200">
                @foreach ($list as $order)  {{-- ⬅️ Mengganti $orders ke $list --}}
                <div class="flex flex-wrap items-center gap-y-4 py-6">
                  <dl class="w-1/2 sm:w-1/4 lg:w-auto lg:flex-1">
                    <dt class="text-base font-medium text-gray-500">Order ID:</dt>
                    <dd class="mt-1.5 text-base font-semibold text-gray-900">
                      <a href="{{ route('orders.show', $order->id) }}" class="hover:underline">#{{ $order->order_number }}</a>
                    </dd>
                  </dl>
                  ...
                  <div class="w-full grid sm:grid-cols-2 lg:flex lg:w-64 lg:items-center lg:justify-end gap-4">
                    ...
                    <!-- View Order Details -->
                    <a href="{{ route('orders.show', $order->id) }}" class="w-full inline-flex justify-center rounded-lg border border-gray-200 bg-white px-3 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none focus:ring-4 focus:ring-gray-100 lg:w-auto">
                      View Details
                    </a>
                  </div>
                </div>
            ...
            <!-- Pagination -->
            @if ($list->hasPages())  {{-- ⬅️ Mengganti $orders ke $list --}}
